/*
 * RemoveMemberAsyncServiceCall.java
 * 13/10/2011
 * TwAPIme for Android
 ...
 */
public class RemoveMemberAsyncServiceCall 
	 ...
	 * @param context
	 */
	public RemoveMemberAsyncServiceCall(Activity context) {
		super(context);
	}
	...
	protected List<com.twitterapime.rest.List> run(
		...
		for (UserAccount user : params) {
			result.add(lmgr.removeMember(list, user));
		}
		//
		return result;
	}
