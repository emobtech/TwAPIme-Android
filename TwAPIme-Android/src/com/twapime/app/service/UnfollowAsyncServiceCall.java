 ...
 */
public class UnfollowAsyncServiceCall 
	extends PostAsyncServiceCall<UserAccount, Void, List<UserAccount>> {
	/**
	 * @param context
	 */
	public UnfollowAsyncServiceCall(Activity context) {
		super(context);
	}
