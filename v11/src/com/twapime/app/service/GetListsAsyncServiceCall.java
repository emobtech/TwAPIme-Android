 ...
 */
public class GetListsAsyncServiceCall 
	extends GetAsyncServiceCall<UserAccount, Void, List[]> {
	/**
	 * @param context
	 */
	public GetListsAsyncServiceCall(Activity context) {
		super(context);
	}
	...
	protected List[] run(UserAccount... params) throws IOException,
		...
		//
		if (params != null) {
			return lmgr.getLists(params[0]);
		} else {
			return lmgr.getLists();
		}
	}
}
